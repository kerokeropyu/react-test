...
import { Button, Container, Fab, TextField, Typography, Box, Grid, Card, CardContent, CardActions, CardMedia } from '@mui/material';
...
const BookSearch = ({books, setBooks}) => {
    ...
    return (<>
        <Container component="section" maxWidth="xl">
            <Fab size="medium" component={Link} to={'/'} sx={{ mt: 1, ml: 1 }}><ArrowBackIcon /></Fab>
        </Container>
        <Container component="section" maxWidth="lg">
            <Box sx={{mt: 2, display: "flex", flexDirection: "column", alignItems: "center"}}>
                ...
                <Box component="form" onSubmit={e => search(keyword, e)} sx={{mt: 1}}>
                    <TextField required fullWidth label="bookSearch" name="search" inputRef={keyword}></TextField>
                    <Button type="submit" fullWidth variant="contained" sx={{ my: 2 }}>検索</Button>
                </Box>
            </Box>
        </Container>
        <Container component="section" maxWidth="lg">
                        ...
                        <Card sx={{height: '100%'}}>
                            <Grid container>
                                ...
                                <Grid item sm={8}>
                                    ...
                                    <CardActions>
                                        <Fab color="primary" onClick={() => {addBook(card)}}><AddIcon /></Fab>
                                    </CardActions>
                                </Grid>
                            </Grid>
                        </Card>
