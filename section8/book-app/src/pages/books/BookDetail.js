import { Button, CardMedia, TextField, Typography, Container, Grid, Box, Card, CardContent, CardActions } from '@mui/material';
        ...
        <Container component="section" maxWidth="md" sx={{ mt: 5 }}>
            <Card sx={{ height: '100%' }}>
                <Grid container>
                    ...
                    <Grid item sm={8}>
                        <CardContent>
                            <Typography sx={{ mb: 2, fontSize: '18px' }}></Typography>
                            <Box sx={{ mb: 2 }}>
                                読んだ日：
                        ...
                        <CardActions>
                            <Grid container>
                                ...
                                <Grid item sm={6}>
                                    <Button color="info" variant="contained" onClick={() => updateBookInfo(book.id)}>保存</Button>
                                </Grid>
                            </Grid>
                        </CardActions>
                    </Grid>
